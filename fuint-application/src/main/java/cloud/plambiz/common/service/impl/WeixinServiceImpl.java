...
import cloud.plambiz.common.bean.H5SceneInfo;
import cloud.plambiz.common.bean.WxPayBean;
import cloud.plambiz.common.bean.shoppingOrders.*;
import cloud.plambiz.common.dto.OrderDto;
import cloud.plambiz.common.dto.UserOrderDto;
import cloud.plambiz.common.dto.WxCardDto;
import cloud.plambiz.common.enums.*;
import cloud.plambiz.common.http.HttpRESTDataClient;
import cloud.plambiz.common.service.*;
import cloud.plambiz.common.util.*;
import cloud.plambiz.common.vo.printer.OrderStatusType;
...
import cloud.plambiz.repository.mapper.MtOrderGoodsMapper;
import cloud.plambiz.repository.mapper.MtUploadShippingLogMapper;
import cloud.plambiz.repository.model.*;
import cloud.plambiz.utils.QRCodeUtil;
        ...
        try {
            ...
            if (data.get("errcode").toString().equals("0")) {
                ...
                try {
                    ...
                    cloud.plambiz.common.util.QRCodeUtil.createQrCode(out, content, 800, 800, "png", "");
                    // 对数据进行Base64编码
