...
import cloud.palmbiz.module.client.request.MemberInfoRequest;
...
public class ClientUserController extends BaseController {
    ...
    public ResponseObject info(HttpServletRequest request) throws BusinessCheckException {
        ...
        if (platform.equals(PlatformTypeEnum.H5.getCode()) && isWechat.equals(YesOrNoEnum.YES.getKey()) && mtUser != null && StringUtil.isNotEmpty(mtUser.getOpenId())) {
            MtSetting cardSetting = settingService.querySettingByName(mtUser.getMerchantId(), cloud.palmbiz.common.enums.SettingTypeEnum.USER.getKey(), UserSettingEnum.OPEN_WX_CARD.getKey());
