package cloud.palmbiz.common.aspect;
...
import cloud.palmbiz.repository.model.TActionLog;
...
public class TActionLogAop {
    ...
    // Service层切点
    @Pointcut("@annotation(cloud.palmbiz.framework.annoation.OperationServiceLog)")
