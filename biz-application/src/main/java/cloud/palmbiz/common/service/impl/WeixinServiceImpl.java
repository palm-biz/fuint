...
import cloud.palmbiz.common.bean.H5SceneInfo;
...
import cloud.palmbiz.common.vo.printer.OrderStatusType;
import cloud.palmbiz.framework.exception.BusinessCheckException;
import cloud.palmbiz.framework.web.ResponseObject;
import cloud.palmbiz.repository.mapper.MtGoodsMapper;
import cloud.palmbiz.repository.mapper.MtOrderGoodsMapper;
import cloud.palmbiz.repository.mapper.MtUploadShippingLogMapper;
import cloud.palmbiz.repository.model.*;
import cloud.palmbiz.utils.QRCodeUtil;
        ...
        try {
            ...
            if (data.get("errcode").toString().equals("0")) {
                ...
                try {
                    ...
                    cloud.palmbiz.common.util.QRCodeUtil.createQrCode(out, content, 800, 800, "png", "");
                    // 对数据进行Base64编码
