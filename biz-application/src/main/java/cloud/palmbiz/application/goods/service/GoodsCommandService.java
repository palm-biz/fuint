...
import cloud.palmbiz.application.goods.command.CreateGoodsCommand;
import cloud.palmbiz.application.goods.command.UpdateGoodsCommand;
import cloud.palmbiz.application.goods.command.UpdateGoodsStatusCommand;
